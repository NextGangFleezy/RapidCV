      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Leverage artificial intelligence to optimize your job search and create compelling application materials.
            </p>
          </div>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-blue-50 border-0">
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">Job Match Analyzer</h3>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/builder"><a className="hover:text-white transition-colors">Resume Builder</a></Link></li>
                <li><Link href="/cover-letter"><a className="hover:text-white transition-colors">Cover Letter Generator</a></Link></li>
                <li><Link href="/job-analyzer"><a className="hover:text-white transition-colors">Job Match Analyzer</a></Link></li>
